...
//		this.ajouterSommet(new Sommet(15, 11, false));
		...
		this.ajouterSommet(new Sommet(250, 0, true));
		this.ajouterSommet(new Sommet(60, 1, false));
		this.ajouterSommet(new Sommet(20, 2, true));
		this.ajouterSommet(new Sommet(20, 3, true));
		this.ajouterSommet(new Sommet(20, 4, true));
		this.ajouterSommet(new Sommet(20, 5, true));
		this.ajouterSommet(new Sommet(110, 6, true));
		this.ajouterSommet(new Sommet(70, 7, false));
		this.ajouterSommet(new Sommet(20, 8, true));
		this.ajouterSommet(new Sommet(60, 9, false));
		this.ajouterSommet(new Sommet(60, 10, false));
	...
	public List<Sommet> majVictimes(List<Sommet> vic, List<Sommet> parcours){
